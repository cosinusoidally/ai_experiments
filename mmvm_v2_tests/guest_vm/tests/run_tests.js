...
(function () {
    ...
    if (threadedVM.runtime.assertions !== 37) {
        throw new Error("threaded compiler assertion count changed");
    }
    threadedVM.destroy();
    var threadedResult = "structured compiler closures passed: 37 assertion(s)";
