...
(function (root) {
    ...
    function NativeInterpreter(runtime) {
        ...
        this.stringSupportAddress = runtime.heapRecords.allocateValueVector(292);
        ...
        runtime.heapRecords.setVectorLength(this.stringSupportAddress, 292);
        this.runCount = 0;
