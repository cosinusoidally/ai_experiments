...
`Math.atan(x)`. The latter lowers to the same binary64 x87 operation with a
denominator of one; numeric inputs and results remain guest value cells and do
not enter the host Math implementation.
